(() => {
  ...
  const X = {
      attachEvents: function () {
        ...
        (e.onTouchStart = N.bind(e)),
          ...
          (e.onClick = q.bind(e)),
          i.touch && !W && (t.addEventListener("touchstart", R), (W = !0)),
          Y(e, "on");
      },
  ...
  function re(e) {
    ...
    function p() {
      ...
      if (
        (t.params.loop
          ? ((l = Math.ceil(
            ...
            l > i - 1 - 2 * t.loopedSlides && (l -= i - 2 * t.loopedSlides),
            l > p - 1 && (l -= p),
            l < 0 && "bullets" !== t.params.paginationType && (l = p + l))
        ...
        if (
          (s.dynamicBullets &&
            ...
            s.dynamicMainBullets > 1 &&
              ...
              ((o += l - (t.previousIndex - t.loopedSlides || 0)),
      ...
      if (
        ("fraction" === s.type &&
          (r.find(ne(s.currentClass)).text(s.formatFractionCurrent(l + 1)),
      ...
      "custom" === s.type && s.renderCustom
        ? (r.html(s.renderCustom(t, l + 1, p)), n("paginationRender", r[0]))
